...
import 'package:wallet_app/screen/CarLoanCalculatorScreen.dart';
...
class CarLoanIntroScreen extends StatelessWidget {
  final CreditCardModel data;

  //var futureList;
  const CarLoanIntroScreen({
    Key? key,
    required this.data,
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              GifView.asset(
                'images/mobile_banking/Record_2023_02_27_15_13_42_846.gif',
                height: 300,
                width: 500,
                frameRate: 30,
              ...
              SliderButton(
                ...
                action: () {
                  ...
                  //   );
                  // });
                  // LoanCalculatorScreen().launch(context);
                  CarLoanCalculatorScreen(data: data,).launch(context);
                },
