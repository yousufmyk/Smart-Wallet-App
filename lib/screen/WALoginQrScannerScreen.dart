...
import '../component/WAAmountScreenLoginPage.dart';
import '../component/WASendMoneyViaQrcodeScreen.dart';
import '../model/cardDetailsModel.dart';

class WALoginQrScannerScreen extends StatefulWidget {
 

  static String tag = '/WAQrScannerScreen';

  @override
  WALoginQrScannerScreenState createState() => WALoginQrScannerScreenState(/*data: data*/);
}

class WALoginQrScannerScreenState extends State<WALoginQrScannerScreen> {
        ...
        children: [
          ScanView(
            ...
            onCapture: (data) {
              if(data.isEmptyOrNull) {
                    LoginSendViaQrCodeScreen(/*data: widget.data,*/).launch(context);
              } else{
                LoginSendViaQrCodeScreen(/*data: widget.data,*/).launch(context);
              }
            },
          ...
          Column(
            children: [
              ...
              30.height,
              Text('Scan QR Code to make payment', style: boldTextStyle(color: Colors.white, size: 18)),
              10.height,
