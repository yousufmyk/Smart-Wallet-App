...
class CarLoanCalculatorScreen extends StatefulWidget {
  ...
  State<CarLoanCalculatorScreen> createState() =>
      _CarLoanCalculatorScreenState(data: data);
}
