...
class E_ComDomesticLimitComponent extends StatefulWidget {
  

  @override
  _E_ComDomesticLimitComponentState createState() =>
      _E_ComDomesticLimitComponentState();
}

class _E_ComDomesticLimitComponentState
    extends State<E_ComDomesticLimitComponent> {
  getLimit() async {
    ...
    if (response.statusCode == 200) {
      ...
      var ecom = (primaryCardInfo as Map)['ecom'];
      final maxAount = (ecom as Map)['maxAmount'];
      return {global.globalEcomDomesticValue = maxAount.toString().toDouble()};

      //print("${maxAmount} this one is the api response");
    } else {
      print("error: Ecom Limit Api is not working");
    }
  }

  var value = global.globalEcomDomesticValue;
            ...
            children: [
              ListTile(
                ...
                title: Padding(
                  ...
                  child: Text('E-Com', style: primaryTextStyle(size: 18)),
                ),
                subtitle: RichText(
                  text: TextSpan(
                ...
                leading: Container(
                  ...
                  child: Image.asset("images/mobile_banking/E-Com.png"),
                ),
              ...
              Padding(
                ...
                child: FluidSlider(
                  ...
                  onChanged: (double newValue) {
                    setState(() {
                      value = newValue;
                      controller.E_ComDomesticLimitValue = newValue;
                    });
                  },
                  min: 0.0,
                  max: 100.0,
