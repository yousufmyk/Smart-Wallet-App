...
class PosDomesticLimitComponent extends StatefulWidget {
 

  @override
  _PosDomesticLimitComponentState createState() =>
      _PosDomesticLimitComponentState();
}

class _PosDomesticLimitComponentState extends State<PosDomesticLimitComponent> {
 getLimit() async {
    ...
    if (response.statusCode == 200) {
        ...
        var pos = (primaryCardInfo as Map)['pos'];
        final maxAount = (pos as Map)['maxAmount'];
        return{
          global.globalPosDomesticValue = maxAount.toString().toDouble()
        };
         
        //print("${maxAmount} this one is the api response");

    } else {
      print("error: POS Limit Api is not working");
    }
  }

  var value = global.globalPosDomesticValue;
            ...
            children: [
              ListTile(
                ...
                title: Padding(
                  ...
                  child: Text('POS', style: primaryTextStyle(size: 18)),
                ),
                subtitle: RichText(
                  text: TextSpan(
                ...
                leading: Container(
                  ...
                  child: Image.asset("images/mobile_banking/pos.png"),
                ),
                ...
                child: FluidSlider(
                  ...
                  onChanged: (double newValue) {
                    setState(() {
                      ...
                      controller.PosDomesticLimitValue = newValue;
                    });
                    print("${newValue} this one is new");
                    print("${value} this one is old");
                  },
                  min: 0.0,
                  max: 100.0,
                ),
