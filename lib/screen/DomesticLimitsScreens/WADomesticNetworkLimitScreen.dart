...
class NetWorkDomesticLimitComponent extends StatefulWidget {
  

  @override
  _NetWorkDomesticLimitComponentState createState() =>
      _NetWorkDomesticLimitComponentState();
}

class _NetWorkDomesticLimitComponentState
    extends State<NetWorkDomesticLimitComponent> {
  getLimit() async {
    ...
    if (response.statusCode == 200) {
        ...
        var nw = (primaryCardInfo as Map)['nw'];
        final maxAount = (nw as Map)['maxAmount'];
        return{
          global.globalNetworkDomesticValue = maxAount.toString().toDouble()
        };
         
        //print("${maxAmount} this one is the api response");

    } else {
      print("error: Network Limit Api is not working");
    }
  }
  var value = global.globalNetworkDomesticValue;
            ...
            children: [
              ListTile(
                ...
                title: Padding(
                  ...
                  child: Text('Network', style: primaryTextStyle(size: 18)),
                ),
                subtitle: RichText(
                  text: TextSpan(
                ...
                leading: Container(
                  ...
                  child: Image.asset("images/mobile_banking/Network.png"),
                ),
              ...
              Padding(
                ...
                child: FluidSlider(
                  ...
                  onChanged: (double newValue) {
                    setState(() {
                      value = newValue;
                      controller.NetWorkDomesticLimitValue = newValue;
                    });
                  },
                  min: 0.0,
                  max: 100.0,
