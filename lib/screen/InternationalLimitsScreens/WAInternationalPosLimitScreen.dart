...
class PosInternationalLimitComponent extends StatefulWidget {
 

  
  @override
  _PosInternationalLimitComponentState createState() =>
      _PosInternationalLimitComponentState();
}

class _PosInternationalLimitComponentState
    extends State<PosInternationalLimitComponent> {
  double value = 10.0;
              ...
              Padding(
                ...
                child: FluidSlider(
                  ...
                  onChanged: (double newValue) {
                    setState(() {
                      value = newValue;
                      controller.PosInternationalLimitValue = newValue;
                    });
                  },
                  min: 0.0,
                  max: 100.0,
