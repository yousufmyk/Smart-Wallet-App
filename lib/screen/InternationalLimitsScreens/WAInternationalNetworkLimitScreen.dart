...
class NetWorkInternationalLimitComponent extends StatefulWidget {
 

  @override
  _NetWorkInternationalLimitComponentState createState() =>
      _NetWorkInternationalLimitComponentState();
}

class _NetWorkInternationalLimitComponentState
    extends State<NetWorkInternationalLimitComponent> {
  double value = 10.0;
              ...
              Padding(
                ...
                child: FluidSlider(
                  ...
                  onChanged: (double newValue) {
                    setState(() {
                      value = newValue;
                      controller.NetWorkInternationalLimitValue = newValue;
                    });
                  },
                  min: 0.0,
                  max: 100.0,
