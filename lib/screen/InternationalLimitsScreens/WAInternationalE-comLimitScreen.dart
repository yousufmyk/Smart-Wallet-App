...
class E_ComInternationalLimitComponent extends StatefulWidget {
  

  @override
  _E_ComInternationalLimitComponentState createState() =>
      _E_ComInternationalLimitComponentState();
}

class _E_ComInternationalLimitComponentState
    extends State<E_ComInternationalLimitComponent> {
  double value = 10.0;
              ...
              Padding(
                ...
                child: FluidSlider(
                  ...
                  onChanged: (double newValue) {
                    setState(() {
                      value = newValue;
                      controller.E_ComInternationalLimitValue = newValue;
                    });
                  },
                  min: 0.0,
                  max: 100.0,
