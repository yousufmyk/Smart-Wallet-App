...
class BreathingGlowingBoxThree extends StatefulWidget {
  /// Width of the button.
  ///
  /// Default value: 60.0.
  final double? width;
  ...
  const BreathingGlowingBoxThree({/*super.key,*/ 
    this.width,
    this.height,
  ...
  @override
  _BreathingGlowingBoxThreeState createState() => _BreathingGlowingBoxThreeState();
}

class _BreathingGlowingBoxThreeState extends State<BreathingGlowingBoxThree>
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Container(
          child: Image(image: 
          AssetImage("images/mobile_banking/Screenshot_2023-02-16_112557-removebg-preview (1).png")
          ),
        )
      //onTap: () => _onTap(),
    ));
