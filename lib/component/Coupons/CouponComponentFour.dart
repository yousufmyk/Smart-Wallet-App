...
class BreathingGlowingBoxFour extends StatefulWidget {
  /// Width of the button.
  ///
  /// Default value: 60.0.
  final double? width;
  ...
  const BreathingGlowingBoxFour({/*super.key,*/ 
    this.width,
    this.height,
  ...
  @override
  _BreathingGlowingBoxFourState createState() => _BreathingGlowingBoxFourState();
}

class _BreathingGlowingBoxFourState extends State<BreathingGlowingBoxFour>
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Container(
          child: Image(image: 
          AssetImage("images/mobile_banking/Screenshot_2023-02-16_114156-removebg-preview (1).png")
          ),
        )
      //onTap: () => _onTap(),
    ));
