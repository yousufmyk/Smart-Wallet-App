...
class BreathingGlowingBoxTwo extends StatefulWidget {
  /// Width of the button.
  ///
  /// Default value: 60.0.
  final double? width;
  ...
  const BreathingGlowingBoxTwo({/*super.key,*/ 
    this.width,
    this.height,
  ...
  @override
  _BreathingGlowingBoxTwoState createState() => _BreathingGlowingBoxTwoState();
}

class _BreathingGlowingBoxTwoState extends State<BreathingGlowingBoxTwo>
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Container(
          child: Image(image: 
          AssetImage("images/mobile_banking/Screenshot_2023-02-16_111759-removebg-preview.png")
          ),
        )
      //onTap: () => _onTap(),
    ));
