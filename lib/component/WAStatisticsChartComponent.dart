...
class WAStatisticsChartComponentState
  ...
  final Color rightBarColor = Color(0xFFFF7426);
  ...
  BarChartGroupData makeGroupData(int x, double y1, double y2) {
    return BarChartGroupData(
      ...
      x: x,
      barRods: [
        BarChartRodData( /*y: y1, colors: [leftBarColor], width: width*/toY: y1,color: WAPrimaryColor,width: width),
        BarChartRodData(/*y: y2, colors: [rightBarColor], width: width*/toY: y2,color: Color(0xFFFF7426),width: width),
      ],
    );
  }
}
