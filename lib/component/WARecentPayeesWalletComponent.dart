...
class WARecentWalletPayeesComponent extends StatefulWidget {
  // final CreditCardModel data;
  // const WARecentWalletPayeesComponent({
  //   Key? key,
  //   required this.data,
  // })  : assert(data != null),
  //       super(key: key);
  ...
  @override
  WARecentWalletPayeesComponentState createState() => WARecentWalletPayeesComponentState(/*data: data*/);
}

class WARecentWalletPayeesComponentState extends State<WARecentWalletPayeesComponent> {
  //  WARecentWalletPayeesComponentState({
  //   required this.data,
  // }) : assert(data != null);
  // final CreditCardModel data;
                       ...
                       child: waCommonCachedNetworkImage(mData.image.validate(), height: 50, width: 50).cornerRadiusWithClipRRect(30),
                        ...
                        () {
                          ...
                          controller.reciverAccountNumController.text = mData.number!;
                                  ...
                                  //SendWalletFragment(data: data).launch(context);
