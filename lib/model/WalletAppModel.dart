...
class WACardModel {
  ...
  WACardModel({this.image, this.balance, this.cardNumber, this.date, this.color, this.name});
}
...
class WACardModel2 {
  ...
  WACardModel2({this.image, this.balance, this.cardNumber, this.date, this.color});
}
